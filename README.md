...
DRY_RUN=1 ABS_URL="https://my_nas_server:13370/audiobookshelf" ABS_TOKEN="abs_api_key" VERIFY_SSL=0 python3 ./abs-cleanup-finished-episodes-v2.py



Example cron entry (runs daily at 3am):

0 3 * * * ABS_URL="https://my_nas_server:13370/audiobookshelf" ABS_TOKEN="your-token" /path/to/abs-cleanup-finished-episodes-v2.py
